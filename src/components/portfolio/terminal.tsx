...
const Terminal = ({ text }: Props) => {
  ...
  return (
    <div className="flex aspect-[4/3] min-h-[24rem] w-full max-w-[40rem] flex-col items-start justify-start rounded-lg border border-primary-200 bg-white font-mono shadow dark:border-primary-800 dark:bg-primary-900">
      ...
      <p className="inline flex-1 whitespace-break-spaces p-8 text-sm xs:text-base">
        {currentText}
        <motion.span
