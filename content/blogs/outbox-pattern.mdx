...
- **Order of publishing:** Publishing in the correct order order of the events is preserved.
...
- The **Outbox pattern** can improve the reliability of a system by performing the create/update/delete of an entity,
  along with persisting events in a **transaction**.
...
- This pattern improves the **reliability** of a system given that events will not be lost.
