...
In distributed systems, it’s common for business workflows to span multiple microservices.
For example, a travel booking service might need to coordinate work across an airline service, hotel service, and car rental service.
...
Services react to events, driving the workflow based on independent triggers.
