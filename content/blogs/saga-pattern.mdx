...
<Alert
  ...
  is left in a state of partial success!"
/>
...
<ThemeImage
  srcLight="/blogs/saga-pattern/example-dark.png"
...
As illustred in the image above, the operation behaves atomically: either all services are booked, or none are, ensuring users won’t be left with partial bookings.

## Conclusion

- The **saga pattern** is an approach to achieve transactions in a **distributed system**.
- This is achieved by each step in a workflow having an associated **compensating actions**,
